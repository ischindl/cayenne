 ...
 * <li>CayenneDataSource.[datasource name].jdbc.minConnections - (optional) Minimal pool
 * size</li>
 * <li>CayenneDataSource.[datasource name].jdbc.maxConnections - (optional) Maximum pool
 * size</li>
 * </ul>
 * <p>
