...
import org.apache.cayenne.testdo.locking.SimpleLockingTest;
import org.apache.cayenne.unit.LockingTestCase;

/**
 * @author Andrus Adamchik, Mike Kienenberger
 */
public class DeleteBatchQueryBuilderTst extends LockingTestCase {
    ...
    public void testCreateSqlString() throws Exception {
        DbEntity entity =
            getDomain().getEntityResolver().lookupDbEntity(SimpleLockingTest.class);
